    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="bg-accent rounded-xl p-6 border border-border">
              <h3 className="text-xl font-semibold text-foreground mb-4">
                {t.forCaregivers.whoCanApply.typesTitle}
              </h3>
              <ul className="space-y-3">
                {[
                  t.forCaregivers.whoCanApply.type1,
                  t.forCaregivers.whoCanApply.type2,
                  t.forCaregivers.whoCanApply.type3,
                  t.forCaregivers.whoCanApply.type4,
                ].map((type, index) => (
                  <li key={index} className="flex items-start gap-2">
                    <svg
                      className="h-5 w-5 text-sidebar-primary mt-0.5 flex-shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
          ...
          <div className="bg-accent rounded-xl p-6 border border-border">
            <h3 className="text-xl font-semibold text-foreground mb-4">
              {t.forCaregivers.whoCanApply.langTitle}
            </h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-foreground/90">
                  {t.forCaregivers.whoCanApply.langGreek}
                </span>
                <span className="text-sidebar-primary font-medium">
                  {t.forCaregivers.whoCanApply.langGreekLevel}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-foreground/90">
                  {t.forCaregivers.whoCanApply.langEnglish}
                </span>
                <span className="text-foreground/70">
                  {t.forCaregivers.whoCanApply.langEnglishLevel}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-foreground/90">
                  {t.forCaregivers.whoCanApply.langOther}
                </span>
                <span className="text-green-600">
                  {t.forCaregivers.whoCanApply.langOtherLevel}
                </span>
              </div>
            </div>
          </div>
...
function Benefits() {
  ...
  const benefits = [
    {
      title: t.forCaregivers.benefits.benefit1Title,
      description: t.forCaregivers.benefits.benefit1Desc,
      icon: "👨‍👩‍👧‍👦",
    },
    {
      title: t.forCaregivers.benefits.benefit2Title,
      description: t.forCaregivers.benefits.benefit2Desc,
      icon: "📱",
    },
    {
      title: t.forCaregivers.benefits.benefit3Title,
      description: t.forCaregivers.benefits.benefit3Desc,
      icon: "⭐",
    },
  ];
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-border">
              <div className="text-center">
                ...
                <div className="text-foreground/90">
                  {t.forCaregivers.benefits.verifiedFamilies}
                </div>
              </div>
            </div>
          </div>
...
function OnboardingProcess() {
  ...
  const steps = [
    {
      step: t.forCaregivers.onboarding.step1Title,
      description: t.forCaregivers.onboarding.step1Desc,
      time: t.forCaregivers.onboarding.step1Time,
      docs: t.forCaregivers.onboarding.step1Docs,
    },
    {
      step: t.forCaregivers.onboarding.step2Title,
      description: t.forCaregivers.onboarding.step2Desc,
      time: t.forCaregivers.onboarding.step2Time,
      docs: t.forCaregivers.onboarding.step2Docs,
    },
    {
      step: t.forCaregivers.onboarding.step3Title,
      description: t.forCaregivers.onboarding.step3Desc,
      time: t.forCaregivers.onboarding.step3Time,
      docs: t.forCaregivers.onboarding.step3Docs,
    },
    {
      step: t.forCaregivers.onboarding.step4Title,
      description: t.forCaregivers.onboarding.step4Desc,
      time: t.forCaregivers.onboarding.step4Time,
      docs: t.forCaregivers.onboarding.step4Docs,
    },
    {
      step: t.forCaregivers.onboarding.step5Title,
      description: t.forCaregivers.onboarding.step5Desc,
      time: t.forCaregivers.onboarding.step5Time,
      docs: t.forCaregivers.onboarding.step5Docs,
    },
  ];
          ...
          <div className="space-y-12">
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="absolute -top-6 lg:relative lg:top-auto left-1/2 lg:left-auto -translate-x-1/2 lg:translate-x-0 z-10">
...
function ProfileGuide() {
  ...
  const profileFeatures = [
    {
      icon: "📸",
      title: t.forCaregivers.profile.feature1Title,
      description: t.forCaregivers.profile.feature1Desc,
    },
    {
      icon: "📝",
      title: t.forCaregivers.profile.feature2Title,
      description: t.forCaregivers.profile.feature2Desc,
    },
    {
      icon: "🛠️",
      title: t.forCaregivers.profile.feature3Title,
      description: t.forCaregivers.profile.feature3Desc,
    },
    {
      icon: "🗓️",
      title: t.forCaregivers.profile.feature4Title,
      description: t.forCaregivers.profile.feature4Desc,
    },
    {
      icon: "🏆",
      title: t.forCaregivers.profile.feature5Title,
      description: t.forCaregivers.profile.feature5Desc,
    },
    {
      icon: "🌐",
      title: t.forCaregivers.profile.feature6Title,
      description: t.forCaregivers.profile.feature6Desc,
    },
  ];
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground">
                  {t.forCaregivers.profile.mockName}
                </h3>
                <p className="text-foreground/70">
                  {t.forCaregivers.profile.mockRole}
                </p>
                <div className="flex items-center mt-2">
                  ...
                  <span className="ml-2 text-sm text-foreground/70">
                    4.9/5 (42 {t.forCaregivers.profile.mockRating})
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-foreground mb-2">
                  {t.forCaregivers.profile.skillsLabel}
                </h4>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-accent px-3 py-1 rounded-full text-sm text-foreground">
                    {t.forCaregivers.profile.skill1}
                  </span>
                  <span className="bg-accent px-3 py-1 rounded-full text-sm text-foreground">
                    {t.forCaregivers.profile.skill2}
                  </span>
                  <span className="bg-accent px-3 py-1 rounded-full text-sm text-foreground">
                    {t.forCaregivers.profile.skill3}
                  </span>
                </div>
              </div>
              ...
              <div>
                <h4 className="font-semibold text-foreground mb-2">
                  {t.forCaregivers.profile.availabilityLabel}
                </h4>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-foreground/90">
                    {t.forCaregivers.profile.availabilityValue}
                  </span>
                </div>
              </div>
              ...
              <div>
                <h4 className="font-semibold text-foreground mb-2">
                  {t.forCaregivers.profile.languagesLabel}
                </h4>
                <div className="flex gap-2">
                  <span className="bg-sidebar-primary/10 text-sidebar-primary px-3 py-1 rounded-full text-sm">
                    {t.forCaregivers.whoCanApply.langGreek}
                  </span>
                  <span className="bg-sidebar-primary/10 text-sidebar-primary px-3 py-1 rounded-full text-sm">
                    {t.forCaregivers.whoCanApply.langEnglish}
...
function TrainingSupport() {
  ...
  const trainingResources = [
    {
      title: t.forCaregivers.training.resource1Title,
      description: t.forCaregivers.training.resource1Desc,
      icon: "📚",
    },
    {
      title: t.forCaregivers.training.resource2Title,
      description: t.forCaregivers.training.resource2Desc,
      icon: "🎬",
    },
    {
      title: t.forCaregivers.training.resource3Title,
      description: t.forCaregivers.training.resource3Desc,
      icon: "📖",
    },
    {
      title: t.forCaregivers.training.resource4Title,
      description: t.forCaregivers.training.resource4Desc,
      icon: "💻",
    },
  ];
