        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-600 leading-relaxed">
              Η MerimnaCare είναι η πρώτη ολοκληρωμένη ψηφιακή πλατφόρμα φροντίδας ηλικιωμένων στην Ελλάδα, 
              σχεδιασμένη για να υποστηρίζει οικογένειες και ηλικιωμένους με αξιοπρέπεια, ασφάλεια και καινοτομία. 
              Ιδρύθηκε από τον Φώτιο Κουζιώρτη, εμπνευσμένος από την προσωπική του εμπειρία φροντίδας των 
              παππούδων του στην ελληνική επαρχία. Αποστολή μας είναι να κάνουμε τη φροντίδα ηλικιωμένων προσβάσιμη, 
              αξιόπιστη και πολιτισμικά προσαρμοσμένη για κάθε ελληνικό νοικοκυριό.
            </p>
          </div>
        </div>
